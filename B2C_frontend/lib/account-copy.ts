...
const en: AccountCopy = {
  ...
  overview: {
    ...
    accountHealthDescription:
      "Complete a few basics so order requests, profile, and support flows stay ready.",
    ...
    placeFirstOrderAction: "Submit your first order request",
    quickActionsTitle: "Quick actions",
    recentOrdersTitle: "Recent orders",
    recentOrdersEmpty: "No order requests yet. Browse the collection to get started.",
  ...
  orders: {
    ...
    title: "Order history",
    description:
      "Track order request status, review details, and handle pending cancellations from your account center.",
    totalOrders: "Total orders",
    activeOrders: "Active orders",
    pendingOrders: "Pending review",
    loadingDetail: "Loading order request details...",
    ...
    nextStepsDescription:
      "Our team reviews each order request manually, then confirms stock, shipping, and payment instructions by email.",
  ...
  store: {
    ...
    checkoutReadyTitle: "Order request readiness",
    checkoutReadyDescription:
      "A default address is available, so order requests can move faster.",
...
const ko: AccountCopy = {
  ...
  overview: {
    ...
    accountHealthDescription: "주문 요청, 프로필, 고객 지원이 원활하게 이루어지도록 기본 정보를 완성해 주세요.",
    readyMessage: "현재 OXP 흐름에 맞게 계정이 잘 설정되어 있습니다.",
    addBioAction: "공개 소개 추가",
    addDefaultAddressAction: "기본 주소 추가",
    placeFirstOrderAction: "첫 주문 요청 제출",
    quickActionsTitle: "빠른 실행",
    recentOrdersTitle: "최근 주문",
    recentOrdersEmpty: "아직 주문 요청이 없습니다. 컬렉션을 둘러보세요.",
  ...
  orders: {
    ...
    pendingOrders: "검토 대기",
    loadingDetail: "주문 요청 상세 정보를 불러오는 중...",
    ...
    nextStepsDescription: "팀이 각 주문 요청을 수동으로 검토한 뒤 재고, 배송, 결제 안내를 이메일로 확인해드립니다.",
    noteTitle: "고객 메모",
  ...
  store: {
    ...
    cartSubtotal: "소계",
    checkoutReadyTitle: "주문 요청 준비 완료",
    checkoutReadyDescription: "기본 주소가 등록되어 있어 주문 요청을 더 빠르게 진행할 수 있습니다.",
...
const zh: AccountCopy = {
  ...
  overview: {
    ...
    accountHealthDescription: "完成基础设置，确保订单请求、个人资料和支持流程顺畅进行。",
    readyMessage: "你的账户已为当前 OXP 流程做好准备。",
    addBioAction: "添加公开简介",
    addDefaultAddressAction: "添加默认地址",
    placeFirstOrderAction: "提交第一笔订单请求",
    quickActionsTitle: "快捷操作",
    recentOrdersTitle: "最近订单",
    recentOrdersEmpty: "还没有订单请求。浏览系列来开始购物。",
  ...
  orders: {
    ...
    nextStepsDescription: "团队会人工审核每笔订单请求，然后通过邮件确认库存、配送和付款说明。",
    noteTitle: "客户备注",
    backToOrders: "返回订单",
    continueShopping: "继续购物",
  },
  ...
  store: {
    ...
    cartEmpty: "你的购物车目前为空。",
    cartSubtotal: "小计",
    checkoutReadyTitle: "订单请求准备完成",
    checkoutReadyDescription: "已有默认地址，可以更快速地提交订单请求。",
