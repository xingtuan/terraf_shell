...
type RootEmailVerifiedPageProps = {
...
export default async function RootEmailVerifiedPage({
  searchParams,
}: RootEmailVerifiedPageProps) {
  ...
  redirect(
    `${getLocalizedHref(locale, "auth/email-verified")}${queryStringWithoutLocale(
