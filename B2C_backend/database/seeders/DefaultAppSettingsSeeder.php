...
class DefaultAppSettingsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $defaults = [
            ...
            'shipping.standard_rate' => ['value' => config('store.shipping.standard_rate', 8), 'type' => 'float'],
            'shipping.fallback_standard_amount' => ['value' => config('store.shipping.standard_rate', 8), 'type' => 'float'],
            'shipping.express_rate' => ['value' => config('store.shipping.express_rate', 14), 'type' => 'float'],
            ...
            'shipping.enabled' => ['value' => true, 'type' => 'boolean'],
            'shipping.estimate_without_address' => ['value' => true, 'type' => 'boolean'],
