    ...
    public function run(): void
    {
        ...
        $material = $this->firstOrCreateSeeded(
            ...
            [
                ...
                'science_overview' => 'Initial material data combines lightweight handling, compressive stability, low water absorption targets, mineral texture, and circular sourcing. Final claims must be validated against project-specific testing.',
                'science_overview_translations' => [
                    'en' => 'Initial material data combines lightweight handling, compressive stability, low water absorption targets, mineral texture, and circular sourcing. Final claims must be validated against project-specific testing.',
                    'zh' => '初始材料数据涵盖轻量化手感、压缩稳定性、低吸水目标、矿物触感与循环来源叙事。最终性能声明需以具体项目测试为准。',
                    'ko' => '초기 소재 정보는 경량감, 압축 안정성, 낮은 흡수율 목표, 미네랄 질감, 순환 원료 스토리를 포함합니다. 최종 성능 주장은 프로젝트별 테스트로 검증해야 합니다.',
                ],
                'certifications' => [
                    [
                        ...
                        'value_translations' => [
                            'en' => '0.00% verification target',
                            'zh' => '0.00% 验证目标',
                            'ko' => '0.00% 검증 목표',
                        ],
                        'result' => '0.00% verification target',
                        'result_translations' => [
                            'en' => '0.00% verification target',
                            'zh' => '0.00% 验证目标',
                            'ko' => '0.00% 검증 목표',
                    ...
                    [
                        ...
                        'value' => 'Initial content - verify before final publication',
                        'value_translations' => [
                            'en' => 'Initial content - verify before final publication',
                            'zh' => '初始内容 - 正式发布前需验证',
                            'ko' => '초기 콘텐츠 - 최종 공개 전 검증 필요',
                        ],
                        'result' => 'Initial content - verify before final publication',
                        'result_translations' => [
                            'en' => 'Initial content - verify before final publication',
                            'zh' => '初始内容 - 正式发布前需验证',
                            'ko' => '초기 콘텐츠 - 최종 공개 전 검증 필요',
        ...
        $specs = [
            ...
            [
                ...
                'detail_translations' => [
                    'en' => 'Initial figure for layout validation. Replace with verified laboratory results before public certification claims.',
        ...
        $applications = [
            ...
            [
                ...
                'subtitle' => 'Material review packs and formulation review',
                'subtitle_translations' => [
                    'en' => 'Material review packs and formulation review',
                    'zh' => '材料评估与配方验证',
                    'ko' => '소재 검토 패키지 및 배합 검토',
                ],
                'description' => 'Designed for material review packs, pellet supply, formulation validation, co-prototyping, and future product development collaborations.',
                'description_translations' => [
                    'en' => 'Designed for material review packs, pellet supply, formulation validation, co-prototyping, and future product development collaborations.',
                    'zh' => '面向材料评估、颗粒供应、配方验证、联合原型和未来产品开发合作。',
                    'ko' => '소재 검토 패키지, 펠릿 공급, 배합 검증, 공동 프로토타이핑, 향후 제품 개발 협업에 적합합니다.',
                ],
