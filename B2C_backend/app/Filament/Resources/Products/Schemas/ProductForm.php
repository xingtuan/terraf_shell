                                        ...
                                        Repeater::make('certifications')
                                            ...
                                            ->schema([
                                                ...
                                                TextInput::make('document_url')
                                                    ->label(__('admin.ui.external_document_url'))
                                                    ->placeholder('https://example.com/document.pdf')
                                                    ->helperText(__('admin.ui.external_document_url_help'))
                                                    ->type('text')
                                                    ->rules(['nullable', 'url'])
                                        ...
                                        Repeater::make('technical_downloads')
                                            ...
                                            ->schema([
                                                ...
                                                FileUpload::make('file_path')
                                                    ...
                                                    ->maxSize(10240),
                                                TextInput::make('url')
                                                    ->label(__('admin.ui.external_file_url'))
                                                    ->placeholder('https://example.com/file.pdf')
                                                    ->helperText(__('admin.ui.external_file_url_help'))
                                                    ->type('text')
                                                    ->rules(['nullable', 'url'])
