...
class StoreOrderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'shipping_address_line1' => ['required_without:address_id', 'string', 'max:255'],
            'shipping_address_line2' => ['nullable', 'string', 'max:255'],
            'shipping_city' => ['required_without:address_id', 'string', 'max:255'],
            'shipping_state_province' => ['nullable', 'string', 'max:255'],
            'shipping_postal_code' => ['required_without:address_id', 'string', 'max:20'],
            'shipping_country' => ['required_without:address_id', 'string', 'size:2', 'in:NZ'],
