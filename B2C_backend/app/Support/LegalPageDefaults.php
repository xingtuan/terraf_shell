        ...
        return [
            'privacy' => [
                'en' => [
                    ...
                    'description' => 'This sample policy explains how OXP collects and uses information across the website, store, community, checkout, and B2B inquiry flows. Review it before launch.',
                ...
                'zh' => [
                    ...
                    'eyebrow' => '隐私政策',
                    'title' => '隐私政策',
                    'description' => '本示例政策说明 OXP 在网站、商店、社区、结账和 B2B 询盘流程中如何收集和使用信息。上线前请完成审阅。',
            ...
            'terms' => [
                ...
                'ko' => [
                    ...
                    'last_updated_label' => '마지막 업데이트',
                    'last_updated' => '2026년 5월',
                    'body_html' => '<h2>OXP 이용</h2><p>사용자는 OXP를 적법하게 이용하고, 주문 또는 문의 시 정확한 정보를 제공하며, 웹사이트나 커뮤니티 기능을 방해하지 않아야 합니다.</p><h2>주문 및 문의</h2><p>스토어 주문, 비회원 결제 요청, 샘플 요청, B2B 문의는 처리 전에 확인, 재고 확인, 결제 안내 또는 후속 연락이 필요할 수 있습니다.</p><h2>콘텐츠와 커뮤니티</h2><p>커뮤니티 제출 내용은 다른 사용자를 존중해야 하며, 플랫폼 보호를 위해 검토, 수정, 숨김 또는 삭제될 수 있습니다.</p>',
                ],
                'zh' => [
                    'meta_title' => '使用条款 | OXP',
                    ...
                    'eyebrow' => '使用条款',
                    'title' => '使用条款',
                    'description' => '本示例条款说明使用 OXP 网站、商店、结账、社区功能和 B2B 询盘流程的一般规则。上线前请完成审阅。',
                    'last_updated_label' => '最后更新',
                    'last_updated' => '2026年5月',
                    'body_html' => '<h2>使用 OXP</h2><p>您同意合法使用 OXP，在下单或提交询盘时提供准确的信息，并避免干扰网站或社区功能。</p><h2>订单与询盘</h2><p>商店订单、游客结账请求、样品请求和 B2B 询盘在履行前可能需要确认、库存核查、付款说明或后续沟通。</p><h2>内容与社区</h2><p>社区提交内容应尊重其他用户。为保护平台，我们可能对内容进行审核、编辑、隐藏或移除。</p>',
                ],
            ],
        ];
    }
