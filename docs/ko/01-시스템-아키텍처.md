...
| **크라우드펀딩** | 펀딩 캠페인 |
| **커뮤니티 설정** | 카테고리, 태그 |
| **시스템** | 앱 설정, 기능 플래그, 커뮤니티 설정, 모더레이션 설정, 이메일 설정, 배송 설정, 세금 설정, 스토리지 설정, NZ Post 설정, 법적 페이지 설정, 설정 백업, 미디어 스토리지 스캔, 인수인계 준비, 초기 콘텐츠 정리 |
...
*관련 코드: `B2C_backend/app/`, `B2C_frontend/`, `B2C_backend/routes/`*
