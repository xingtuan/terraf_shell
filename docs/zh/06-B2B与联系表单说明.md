...
OXP 平台提供多种商务询盘渠道，包括通用联系表单、结构化 B2B 询盘、合作伙伴询盘和材料申请。所有提交记录保存至数据库，并通过管理后台进行管理。
...
| 材料申请 | `POST /api/sample-requests` | `SampleRequest` | 申请产品评估材料 |
...
| `SampleRequest` | `sample_requests` | 材料申请 |
